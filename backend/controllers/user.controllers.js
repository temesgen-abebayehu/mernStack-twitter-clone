...
import Notificcation from "../models/notification.model.js";
...
export const followUnfollowUser = async (req, res)=>{
    try {
        ...
        if(isFollowing){
            ...
            // const newNotification = new Notificcation({
            //     type: "unfollow",
            //     from: req.user._id,
            //     to: userToModify._id,
            // });
            ...
            //return the id of the user as a responce
...
export const updatedUserProfile = async (req, res)=>{
    ...
    try {
        ...
        //password should be null in the responce
        user.password = null;
